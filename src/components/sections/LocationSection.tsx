    ...
    <section className="relative min-h-[700px] flex items-center bg-surface-base" id="contato">
      ...
      <div className="absolute inset-0 z-0 bg-surface-base">
        <iframe 
          ...
          width="100%" 
          height="100%" 
          style={{ border: 0, filter: 'grayscale(0.8) sepia(0.5) hue-rotate(150deg) brightness(0.4) contrast(1.2)' }} 
          allowFullScreen 
          loading="lazy" 
          referrerPolicy="no-referrer-when-downgrade"
          className="pointer-events-none mix-blend-screen opacity-60"
        />
      ...
      <div className="container relative z-10 px-4 mx-auto max-w-7xl flex justify-start">
        <div className="clinical-glass p-8 md:p-12 max-w-xl w-full rounded-[2.5rem]">
          <div className="flex items-center gap-3 mb-10">
            <h2 className="text-3xl font-display font-light text-white tracking-tight">Status de <span className="font-serif italic text-primary">Atendimento</span></h2>
            <div className={`px-3 py-1.5 flex items-center gap-2 rounded-full border ${isOpen ? 'border-primary text-emerald-100 bg-primary/20' : 'border-slate-500 text-slate-300 bg-slate-800/50'}`}>
              <div className={`w-2 h-2 rounded-full ${isOpen ? 'bg-primary animate-pulse shadow-[0_0_10px_rgba(16,185,129,1)]' : 'bg-slate-400'}`} />
          ...
          <div className="space-y-6 mb-10">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="text-white font-display font-semibold mb-1">Localização</h4>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="text-white font-display font-semibold mb-1">Horário de Funcionamento</h4>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="text-white font-display font-semibold mb-1">Contato Rápido</h4>
